<template>
  ...
  <div class="courses">
    ...
    <div class="filter">
      ...
      <div
        :class="isFilter ? 'filter__active' : ''"
        class="container row filter__menu"
      >
