      ...
      <div class="container row">
        ...
        >
          ...
          <div class="singlePage__name row">
            ...
            <span class="date"
              >Oxirgi marta yangilanishi :
              {{ postTime(singleReport.data.date) }}</span
            >
          </div>
          <div class="singlePage__selled row">
            ...
            <p>
              <span>{{ singleReport.data.sell_count }}</span> kishi allqachon
              kursni sotib oldi
            </p>
          </div>
          ...
          <div class="singlePage__list">
            <div
              class="kurs__name row"
              v-for="(item, index) in singleReport.data.videos"
              :key="index"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          class="singlePage__details"
          data-aos="fade-left"
          data-aos-once="true"
          data-aos-duration="1000"
        >
          <div class="kurs__narxi">
            <span class="exactPrice"
              >{{ singleReport.data.price - singleReport.data.discount }}
              <span>so'm</span></span
            >
          ...
          <div class="singlePage__features">
            ...
            <div class="feature row">
              ...
              <span
                >{{ Math.floor(Math.random() * 100) }} soatlik
                videodarslik</span
              >
            </div>
            <div class="feature row">
          ...
          <div class="singlePage__buy row">
            ...
            >
              ...
              <span>{{
                count == 1 ? "Savatga qo'shildi" : "Savatga qo'shish"
              }}</span>
            </button>
...
export default {
  ...
  methods: {
    ...
    postTime(d) {
      ...
      const time = `${hours.toString().length == 1 ? "0" : ""}${hours}:${
        minute.toString().length == 1 ? "0" : ""
      }${minute}`;
      const year = date.getFullYear();
      return `${time}  /  ${day.toString().length == 1 ? "0" : ""}${day}.${
